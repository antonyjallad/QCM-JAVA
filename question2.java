...
public class question2 extends javax.swing.JFrame {
    public question2(String para,String tot) {
                project();
        t1.setText(para);
        t2.setText(tot);
        b2.setVisible(false);
    ...
    private void project() {
        ...
        l3.setText("Which team has 4 title and did not participate?");
    ...
    private void b2MouseClicked(java.awt.event.MouseEvent evt) {
        String msg = t1.getText();
        String tot = t2.getText();
        //new question3(msg,tot).setVisible(true);
        this.setVisible(false);
    }
