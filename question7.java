...
public class question7 extends javax.swing.JFrame {
    question7(String para,String tot) {
                project();
        t1.setText(para);
        t2.setText(tot);
        b2.setVisible(false);
    ...
    private void project() {
        ...
        l1.setText("Question 7");

        l3.setFont(new java.awt.Font("TimesRoman", 0, 24));
        l3.setText("Which one is the manager of the winning team ?");
            ...
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("file:/C:/Users/Anthony Jalad/Downloads/hello.jpg")
                    );
        ...
        r2.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("file:/C:/Users/Anthony Jalad/Downloads/r.jpg")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
        ...
        r3.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("file:/C:/Users/Anthony Jalad/Downloads/hey.jpg")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
        ...
        r4.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("file:/C:/Users/Anthony Jalad/Downloads/images.jpg")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
    ...
    private void b2MouseClicked(java.awt.event.MouseEvent evt) {
        ...
        new question8(msg,tot).setVisible(true);
