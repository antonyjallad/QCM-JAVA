...
public class question6 extends javax.swing.JFrame {
    question6(String para,String tot) {
                project();
        t1.setText(para);
        t2.setText(tot);
        b2.setVisible(false);
    ...
    private void project() {
        ...
        l1.setText("Question 6");
        l3.setFont(new java.awt.Font("TimesRoman", 0, 24));
        l3.setText("What is the form of the Cup?");
            ...
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("file:/C:/Users/Anthony Jalad/Downloads/laliga.jpg")
                    );
        ...
        r2.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("file:/C:/Users/Anthony Jalad/Downloads/download.jpg")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
        ...
        r3.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("file:/C:/Users/Anthony Jalad/Downloads/f.jpg")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
        ...
        r4.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("file:/C:/Users/Anthony Jalad/Downloads/c.jpg")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
    ...
    private void b2MouseClicked(java.awt.event.MouseEvent evt) {
        ...
        new question7(msg,tot).setVisible(true);
