...
public class question4 extends javax.swing.JFrame {
    public question4(String para,String tot) {
                project();
        t1.setText(para);
        t2.setText(tot);
        b2.setVisible(false);
...
private void b2MouseClicked(java.awt.event.MouseEvent evt) {
        ...
        new question5(msg,tot).setVisible(true);
