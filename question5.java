...
public class question5 extends javax.swing.JFrame {
    question5(String para,String tot) {
                project();
        t1.setText(para);
        t2.setText(tot);
        b2.setVisible(false);
...
private void b2MouseClicked(java.awt.event.MouseEvent evt) {
        ...
        new question6(msg,tot).setVisible(true);
